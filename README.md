...
Для нагрузочного тестирования используется инструмент Locust. Тесты находятся в директории `tests/load/`.

#### Настройка и запуск нагрузочных тестов

1. Установите зависимости для нагрузочного тестирования:
```bash
pip install -r tests/load/requirements.txt
```

2. Убедитесь, что приложение запущено (обычно на http://localhost:8000)
...
1. **Создание одиночной ссылки** (вес: 1)
   - Тестирование создания отдельных сокращенных ссылок
   - Проверка базовой функциональности

2. **Массовое создание ссылок** (вес: 2)
   - Создание 5 ссылок подряд
   - Проверка производительности при массовой нагрузке

3. **Чтение и перенаправление** (вес: 3)
   - Создание и многократное обращение к ссылке
   - Проверка эффективности кэширования

4. **Поиск ссылок** (вес: 1)
   - Создание и поиск ссылок
   - Тестирование поисковой функциональности под нагрузкой
